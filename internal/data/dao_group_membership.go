...
func (*groupMembershipDaoImpl) CreateDBObjects(ctx context.Context) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on GroupMembershipDao/CreateDBObjects query: ", err)
		return err
	}
	return nil
}
...
func (*groupMembershipDaoImpl) InsertRow(ctx context.Context, userId string, groupId string) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on GroupMembershipDao/InsertRow query: ", err)
		return err
	}
	return nil
}
