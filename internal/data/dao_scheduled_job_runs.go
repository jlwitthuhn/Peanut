...
func (*scheduledJobRunDaoImpl) CreateDBObjects(ctx context.Context) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on ScheduledJobRunDao/CreateDBObjects query: ", err)
		return err
	}
	return nil
}
...
func (*scheduledJobRunDaoImpl) InsertRow(ctx context.Context, jobId string, success bool) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on ScheduledJobRunDao/InsertRow query: ", err)
		return err
	}
	return nil
}
