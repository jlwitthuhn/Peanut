...
func (*sessionDaoImpl) CreateDBObjects(ctx context.Context) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on SessionDao/CreateDBObjects query: ", err)
		return err
	}
	return nil
}
...
func (*sessionDaoImpl) CountValidDedupeByUser(ctx context.Context) (int64, error) {
	...
	err := row.Scan(&count)
	if err != nil {
		logger.Error(ctx, "Got database error on SessionDao/CountValidDedupeByUser query: ", err)
		return 0, err
	}
	return count, nil
}
...
func (*sessionDaoImpl) DeleteRowById(ctx context.Context, sessionId string) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on SessionDao/DeleteRowById query: ", err)
		return err
	}
	return nil
}
...
func (*sessionDaoImpl) DeleteRowsByExpired(ctx context.Context) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on SessionDao/DeleteRowsByExpired query: ", err)
		return err
	}
	return nil
}
...
func (*sessionDaoImpl) InsertRow(ctx context.Context, sessionId string, userId string) error {
	...
	if err != nil {
		logger.Error(ctx, "Got database error on SessionDao/InsertRow query: ", err)
		return err
	}
	return nil
}
...
func (*sessionDaoImpl) SelectValidRowBySessionId(ctx context.Context, sessionId string) (*SessionRow, error) {
	...
	if err != nil {
		if err == sql.ErrNoRows {
			...
			logger.Error(ctx, "Got database error on SessionDao/SelectValidRowBySessionId query: ", err)
			return nil, err
		}
	}
	return result, nil
