...
func main() {
	...
	scheduledJobRunDao := data.NewScheduledJobRunDao()
	...
	forumPostListingDvao := data.NewForumPostListingDvao()
	forumThreadSummaryDvao := data.NewForumThreadSummaryDvao()
	...
	forumThreadService := service.NewForumThreadService(forumPostsDao, forumThreadsDao, forumThreadSummaryDvao, forumPostListingDvao)
	...
	setupService := service.NewSetupService(
		...
		forumHomeDvao, forumPostListingDvao, forumThreadSummaryDvao,
