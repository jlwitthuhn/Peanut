...
func main() {
	...
	forumsService := service.NewForumsService(forumsDao, forumSectionsDao, systemLogDao)
	...
	ep_admin.RegisterAdminHandlers(
		...
		sessionService,
		userService)
	ep_forums.RegisterForumHandlers(middlewareMux, forumHomeDvao, forumsService)
